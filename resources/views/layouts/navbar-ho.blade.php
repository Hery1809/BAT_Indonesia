                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-3">
                                ...
                                <div class="row img-gallery">
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{ asset('assets/img/thumbs/img-1.jpg') }}"
                                            alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{ asset('assets/img/thumbs/img-3.jpg') }}"
                                            alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{ asset('assets/img/thumbs/img-2.jpg') }}"
                                            alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{ asset('assets/img/thumbs/img-4.jpg') }}"
                                            alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{ asset('assets/img/thumbs/img-6.jpg') }}"
                                            alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{ asset('assets/img/thumbs/img-5.jpg') }}"
                                            alt="thumbs">
                                    </div>
                                </div>
