                        ...
                        <div class="pad-btm form-inline">
                            <div class="row">
                                <div class="col-sm-6 table-toolbar-left">
                                    <form method="GET" action="{{ route('hod.coverage.index') }}" class="form-inline">
                                        ...
                                        <tr>
                                            ...
                                            @for ($week = 1; $week <= 5; $week++)
                                                <td>
                                                    @php
                                                        $coverage = $items
                                                            ->coverage($week, $monthnow, $yearnow, $items->depo_id)
                                                            ->first();
                                                    @endphp

                                                    @if ($coverage)
                                                        @switch($coverage->c_verify)
                                                            @case(1)
                                                                <a href="{{ route('hod.coverage.detail', $coverage->c_id) }}">
