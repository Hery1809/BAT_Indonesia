                    ...
                    <div class="pad-btm form-inline">
                        <div class="row">
                            <div class="col-sm-6 table-toolbar-left">
                                <form method="GET" action="{{ route('hod.stockcount.index') }}" class="form-inline">
                                    ...
                                    <tr>
                                        ...
                                        @for ($week = 1; $week <= 5; $week++)
                                            <td>
                                                @php
                                                    $stockcount = $items
                                                        ->stockcount($week, $monthnow, $yearnow, $items->depo_id)
                                                        ->first();
                                                @endphp

                                                @if ($stockcount)
                                                    @switch($stockcount->sc_verify)
                                                        @case(1)
                                                            <a href="{{ route('hod.stockcount.detail', $stockcount->sc_id) }}">
