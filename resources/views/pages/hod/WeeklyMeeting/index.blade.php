        ...
        <div class="col-xs-12">
            ...
            <div class="tab-base">
                ...
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="{{ route('hod.weeklymeeting.index') }}">Activity</a>
                    </li>
                    <li>
                        <a href="{{ route('hod.weeklymeeting.report') }}">Report</a>
                    </li>
                </ul>
                        ...
                        <div class="pad-btm form-inline">
                            <div class="row">
                                <div class="col-sm-6 table-toolbar-left">
                                    <form method="GET" action="{{ route('hod.weeklymeeting.index') }}"
                                        class="form-inline">
                                        ...
                                        <tr>
                                            ...
                                            @for ($week = 1; $week <= 5; $week++)
                                                <td>
                                                    @php
                                                        $meeting = $items
                                                            ->meetingweekly($week, $monthnow, $yearnow, $items->depo_id)
                                                            ->first();
                                                    @endphp

                                                    @if ($meeting)
                                                        @switch($meeting->mw_verify)
                                                            @case(1)
                                                                <a href="{{ route('hod.weeklymeeting.detail', $meeting->mw_id) }}">
