...
@section('EHSFacility', 'active-sub')
@section('content')
        ...
        <div class="col-xs-12">
            ...
            <div class="tab-base">
                ...
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="{{ route('hod.ehsfacility.index') }}">Activity</a>
                    </li>
                    <li>
                        <a href="{{ route('hod.ehsfacility.report') }}">Report</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div id="demo-lft-tab-1" class="tab-pane fade  active in">
                        ...
                        <h4 class="text-main text-bold mar-no">EHS & Facility</h4>
                        <p>&nbsp;</p>
                        ...
                        <div class="pad-btm form-inline">
                            <div class="row">
                                <div class="col-sm-6 table-toolbar-left">
                                    <form method="GET" action="{{ route('hod.ehsfacility.index') }}" class="form-inline">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($depos as $items)
                                        <tr>
                                            ...
                                            <?php
                                            $data_ehs = ['Warehouse', 'Sales', 'Security', 'Admin', 'Non Routine'];
                                            ?>
                                            @foreach ($data_ehs as $row)
                                                <td>
                                                    @php
                                                        $ehs = $items
                                                            ->ehs($row, $monthnow, $yearnow, $items->depo_id)
                                                            ->first();
                                                    @endphp

                                                    @if ($ehs)
                                                        @switch($ehs->ehs_verify)
                                                            @case(1)
                                                                <a href="{{ route('hod.ehsfacility.detail', $ehs->ehs_id) }}">
                                            ...
                                            <td>
                                                @php
                                                    $ehsform = $items
                                                        ->ehsform($monthnow, $yearnow, $items->depo_id)
                                                        ->first();
                                                @endphp

                                                @if ($ehsform)
                                                    @switch($ehsform->ef_verify)
                                                        @case(1)
                                                            <a href="{{ route('hod.ehsfacility.form', $ehsform->ef_id) }}">
                                                                <button class="btn btn-warning submit2" title="Status">to
                                                                    review</button>
                                                            </a>
                                                        @break
