                ...
                <div class="panel-body">
                    ...
                    <form method="POST" class="action" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-3 text-center">
                            <div class="panel-body">
                                <img class="img-circle" src="https://batidistributor.com/staging/assets/icon/user.png"
                                    onerror="this.onerror=null;this.src='https://batidistributor.com/staging/assets/icon/user.png';"
                                    alt="" width="120px" height="120px" id="img1">
                        ...
                        <div class="col-sm-3">
                            <div class="panel-body">
                                ...
                                <input type="text" name="user_name" value="asm@bat.com" class="form-control"
                        ...
                        <div class="col-sm-3">
                            <div class="panel-body">
                                ...
                                <input type="text" name="user_last_name" value="asm" class="form-control"
                    ...
                    <form method="POST" class="action">
                        ...
                        <div class="col-sm-3">
                            <div class="panel-body">
                                <br>
                                <button type="submit" class="btn btn-primary submit" onclick="return Validate();">
                                    CHANGE</button>
                            </div>
                        </div>
                    </form>
