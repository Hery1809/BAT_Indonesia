            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <div id="table-stock_level_verify_asm_wrapper"
                            class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_length" id="table-stock_level_verify_asm_length"><label>Show
                                            <select name="table-stock_level_verify_asm_length"
                                                aria-controls="table-stock_level_verify_asm"
                                ...
                                <div class="col-sm-6">
                                    <div id="table-stock_level_verify_asm_filter" class="dataTables_filter">
                                        <label>Search:<input type="search" class="form-control input-sm" placeholder=""
                                                aria-controls="table-stock_level_verify_asm"></label></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="table-stock_level_verify_asm"
                                        class="table table-striped dataTable no-footer dtr-inline" cellspacing="0"
                                        width="100%" role="grid" aria-describedby="table-stock_level_verify_asm_info"
                                        style="width: 100%;">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="table-stock_level_verify_asm" rowspan="1" colspan="1"
                                    ...
                                    <div id="table-stock_level_verify_asm_processing"
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="dataTables_info" id="table-stock_level_verify_asm_info" role="status"
                                        aria-live="polite">Showing 0 to 0 of 0 entries</div>
                                </div>
                                <div class="col-sm-7">
                                    <div class="dataTables_paginate paging_simple_numbers"
                                        id="table-stock_level_verify_asm_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button previous disabled"
                                                id="table-stock_level_verify_asm_previous"><a href="#"
                                                    aria-controls="table-stock_level_verify_asm" data-dt-idx="0"
                                                    tabindex="0">Previous</a></li>
                                            <li class="paginate_button next disabled"
                                                id="table-stock_level_verify_asm_next"><a href="#"
                                                    aria-controls="table-stock_level_verify_asm" data-dt-idx="1"
