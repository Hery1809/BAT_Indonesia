    ...
    <div class="col-sm-3">
        <div class="form-group">
            <label class="col-sm-12 text-semibold">
                Distributor</label>
            <div class="col-sm-12">
                 <select name="distributor_id" id="distributor_id" onchange="select_distributor_asm(this.value);" class="form-control" required="">
...
<div class="row">
    <div class="col-sm-7">
        <div class="panel panel-bordered-default">
            ...
            <div class="col-sm-4">
                <button class="btn btn-default btn-icon btn-xs btn-circle"><i class="fa fa-circle"></i></button> Not Started
            </div>
            <div class="col-sm-4">
                <button class="btn btn-warning btn-icon btn-xs btn-circle"><i class="fa fa-circle"></i></button> On Review
            </div>
            <div class="col-sm-4">
                <button class="btn btn-info btn-icon btn-xs btn-circle"><i class="fa fa-check"></i></button> Verified
            </div>
        </div>
    </div>
</div>
