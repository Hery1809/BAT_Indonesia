                            ...
                            <div class="col-sm-6">
                                <div class="dataTables_length" id="table-ffis_payment_verify_asm_length"><label>Show
                                        <select name="table-ffis_payment_verify_asm_length"
                                            aria-controls="table-ffis_payment_verify_asm" class="form-control input-sm">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="table-ffis_payment_verify_asm"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0"
                                                aria-controls="table-ffis_payment_verify_asm" rowspan="1" colspan="1"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="9" style="text-align: center; vertical-align: middle;">No data
